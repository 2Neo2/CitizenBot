...
@router.callback_query(F.data.in_('strelka_back'))
async def start_strelka_questions(call: CallbackQuery):
    mess = messages.question_message
    await call.message.edit_text(mess, reply_markup=buttons.get_sections_strelka_keyboard())
    await call.answer()
...
async def start_strelka_questions(call: CallbackQuery):
    mess = messages.question_message
    await call.message.edit_text(mess, reply_markup=buttons.exchenge_section_keyboard())
    await call.answer()
...
async def start_strelka_questions(call: CallbackQuery):
    mess = messages.question_message
    await call.message.edit_text(mess, reply_markup=buttons.tariffs_section_keyboard())
    await call.answer()
...
async def start_strelka_questions(call: CallbackQuery):
    mess = messages.question_message
    await call.message.edit_text(mess, reply_markup=buttons.benefits_section_keyboard())
    await call.answer()
