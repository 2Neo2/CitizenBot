...
def to_list(**d):
    ...
    Request.Body.filters(json, 'withTrashed', d.get('is_delete')) # Отображать удаленые значения True / False
    # Request.Body.filters(json, 'withSource',  d.get('source'), 'to_list') # Фильтры по ключу можно добавить функции 'to_str', 'to_list'
