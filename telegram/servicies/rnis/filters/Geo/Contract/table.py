...
def table(**d):
    ...
    Request.Body.filters(json, 'onlyVis', d.get('isVIS', False)) # Фильтры по является ВИС
    Request.Body.filters(json, 'withComponent', d.get('component', 'kiutr')) # Фильтры по компоненту дефолт kiutr
