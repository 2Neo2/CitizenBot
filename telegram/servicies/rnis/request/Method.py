class Method:
    ...
    class Geo:
        ...
        class Contract:
            ...
            table   = 'com.rnis.geo.action.contracts.table.export' # Создание идентификатора выгрузки
            export  = 'com.rnis.system.action.export.get' # Получение выгрузки по идентификатору
    ...
    class Dictionary:
        ...
        carrier   = 'com.rnis.grpc-proxy.action.units.get.units'
